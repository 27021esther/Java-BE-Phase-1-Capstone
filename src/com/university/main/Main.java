...
import com.university.service.UniversityManager;
import com.university.util.FileManager;
        ...
        while(true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    manager.registerStudent(new UndergraduateStudent(id, name, gpa, dept));
